...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: `Contact Dental Plus | Best Dental Clinic in Ajabpur Kalan Dehradun` },
      { property: "og:description", content: `Get directions, timings, and contact details for Dental Plus Clinic in Dehradun. Reach Dr. Jigyasa Bhardwaj at ${CLINIC.phonesDisplay[0]} or message on WhatsApp.` },
