...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dental Treatments & Services in Dehradun | Dental Plus" },
      { property: "og:description", content: "Explore our range of general, cosmetic & restorative dental treatments including painless root canals, implants, whitening, and veneers in Dehradun by Dr. Jigyasa Bhardwaj." },
