...
export const CONSENT_TEXT: Record<"en" | "hi", ConsentTranslation> = {
  ...
  hi: {
    ...
    subtitle: "रोगी नैदानिक सहमति पत्र",
    patientParticulars: "1. रोगी का विवरण",
    ...
    successDesc: "आपका डिजिटल रोगी सहमति रिकॉर्ड संकलित और सुरक्षित कर लिया गया है। इस हस्ताक्षरित सहमति की एक प्रति आपके अपॉइंटमेंट स्लॉट को लॉक करने के लिए हमारे व्हाट्सएप समन्वयक को भेज दी गई है।",
